...
public class AnimationRect {
    ...
    private static float          sRotationLimitedMax =
            PIPCustomization.TOP_GRAPHIC_MAX_ROTATE_VALUE;
    private static float          sRotationLimitedMin =
            -PIPCustomization.TOP_GRAPHIC_MAX_ROTATE_VALUE;
...
//        rotate(rotationRotate);
    ...
    public static float checkRotationLimit(float rotation, float rotatedRotation) {
        ...
        float mcurrentRotaedRotation = (rotatedClockwise ==
                currentRotatedClockwire) ? rotatedRotation
                : -rotatedRotation;
