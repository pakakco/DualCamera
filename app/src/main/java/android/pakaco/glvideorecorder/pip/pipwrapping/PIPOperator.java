...
public class PIPOperator implements PipCaptureExecutor.ImageCallback {
    ...
    public interface Listener {
        ...
        void updateTouchedTabPostion(int x, int y, boolean flag);
    }
    ...
    public PIPOperator(Service service, Listener listener)
    {
        mService = service;
        mListener = listener;
		mActivity = null;
    ...
    public void initPIPRenderer() {
        ...
        if (mRendererManager == null) {
            if(mActivity != null)
                ...
                mRendererManager = new RendererManager(mService);
        }
        ...
        mRendererManager.setListener(mListener);
    }
    ...
    public void setCurrTouchTapPostion(int x, int y)
    {
        mRendererManager.setCurrTouchTapPostion(x, y);
    }

    /*public void setLogoSelected(int i)
    {
        if(mRendererManager != null)
            mRendererManager.setLogoSelected(i);
    }*/

    public void setRenderDrawPause(boolean flag)
    {
        if(mRendererManager != null)
            mRendererManager.setRenderDrawPause(flag);
    }
    ...
    public  void updateScreenRenderParameter(float anglex,float angley,float rate){
        if(mRendererManager != null){
            mRendererManager.updateScreenRenderParameter(anglex,angley,rate);
        }
    }
}
